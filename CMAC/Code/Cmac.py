...
def Generate_Dataset(inputFunction):
   ...
   #Split Dataset into training and testing sets. (70%training and 30%testing)
    ...
    return[input_dataset,output_dataset,input_train,input_test,output_train, output_test,train_global_indices,test_global_indices,resolution_rad]
        ...
        while Local_Convergence is False:
            ...
            for j in range (0, GeneralizationFactor):
                ...
                if total_neighbourhood_index >=0 and total_neighbourhood_index < input_dataset_size :
                    ...
                    weights[total_neighbourhood_index] = weights[total_neighbourhood_index] + (error/(GeneralizationFactor + offset_val))
                    cmac_output += input_dataset[total_neighbourhood_index]* weights[total_neighbourhood_index]
